...
- (void)configureCommonAttributes
{
     ...
     *  导航栏颜色
     */
    [[UINavigationBar appearance] setBarTintColor:MX_NAV_BARTINT_COLOR];
    
    /**
     *  导航栏标题字体和字体颜色
     */
    NSMutableDictionary *titleTextAttributes = [NSMutableDictionary dictionary];
    [titleTextAttributes setValue:MX_NAV_TITLE_FONT forKey:NSFontAttributeName];
    [titleTextAttributes setValue:MX_NAV_TITLE_COLOR forKey:NSForegroundColorAttributeName];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self.viewControllers.count) {
        if (!viewController.navigationItem.hidesBackButton) {
            UIImage *image = [UIImage imageNamed:@"mx_nav_back_image.png"];
...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    self.popGestureRecognizer.enabled = (!isRootViewController && self.interactivePopGestureRecognizerEnabled);
